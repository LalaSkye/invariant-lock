...
**Repository:** invariant-lock
**Purpose:** Refuse execution unless the invariant file's hash and version both match the lock. Defence against silent drift.
**Author:** Ricky Dean Jones
**Repository owner:** [LalaSkye](https://github.com/LalaSkye)
**Organisation:** Os-Trilogy LMT / AlvianTech
**Architecture layer:** Drift prevention
**Licence:** MIT

## Related Artefacts

TrinityOS, AlvianTech, Execution Boundary Series, csgr-lab

## Public vs Private

**Public (this repository):** Full implementation (~130 LOC), CLI, test suite, API.

**Private (withheld by design):** Production invariant files. Internal governance rule sets.
